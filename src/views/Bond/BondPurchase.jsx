...
function BondPurchase({ bond, slippage, recipientAddress }) {
  ...
  //console.log("PRICEL " + bond.maxBondPrice * bond.bondPrice.toString())
        ...
        <Box className="bond-data">
          ...
          <div className={`data-row`}>
            ...
            <Typography id="bond-value-id" className="price-data">
              {isBondLoading ? <Skeleton width="100px" /> : `${trim(bond.bondQuote, 4) || "0"} 3DOG`}
            </Typography>
          </div>
          ...
          <div className={`data-row`}>
            ...
            <Typography id="bond-value-id" className="price-data">
              {isBondLoading ? <Skeleton width="100px" /> : `${trim(bond.maxBondPrice, 4) || "0"} 3DOG`}
            </Typography>
          </div>
