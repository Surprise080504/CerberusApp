...
export const tooltipInfoMessages = {
  tvl: "Total Value Deposited, is the dollar amount of all 3DOG staked in the protocol. This metric is often used as growth or health indicator in DeFi projects.",
  mvt: "Market Value of Treasury Assets, is the sum of the value (in dollars) of all assets held by the treasury.",
  rfv: "Risk Free Value, is the amount of funds the treasury guarantees to use for backing 3DOG.",
  ...
  staked: "3DOG Staked, is the ratio of sOHM to 3DOG (staked vs unstaked)",
