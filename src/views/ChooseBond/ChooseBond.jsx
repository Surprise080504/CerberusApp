    ...
    if (state.bonding.loading == false) {
      ...
      for (const bond in allBondsMap) {
        if (state.bonding[bond]) {
          if (state.bonding[bond].bond === "shib"){
            tokenBalances += state.bonding[bond].purchased * 100000000;
          } else if (state.bonding[bond].bond === "dog_eth_lp"){
            tokenBalances += state.bonding[bond].purchased  * Math.pow(10, 1)
          }
        }
      }
