                ...
                <Grid container spacing={2} alignItems="flex-end">
                  ...
                  <Grid item xs={12} sm={4} md={4} lg={4}>
                    <div className="stake-index">
                      ...
                      <Typography variant="h4">
                        {currentIndex ? (
                          <> {new Intl.NumberFormat("en-US").format(trim(currentIndex, 1))} 3DOG</>
                        ) : (
                          <Skeleton width="150px" />
                        )}
                      </Typography>
            ...
            <div className="staking-area">
              {!address ? (
                <div className="stake-wallet-notification">
                  ...
                  <Typography variant="h6">Connect your wallet to stake 3DOG</Typography>
                </div>
              ) : (
                <>
                  ...
                  <div className={`stake-user-data`}>
                    <div className="data-row">
                      ...
                      <Typography variant="body1">
                        {stakingAPY === undefined ? (
                          ...
                          <>{new Intl.NumberFormat("en-US").format(trim(ohmBalance, 4))} 3DOG</>
                        )}
                      </Typography>
                    </div>
                    ...
                    <div className="data-row">
                      ...
                      <Typography variant="body1">
                        {stakingAPY === undefined ? (
                          ...
                          <>{new Intl.NumberFormat("en-US").format(trimmedBalance)} 3DOGs</>
                        )}
                      </Typography>
                    </div>
                    ...
                    <div className="data-row">
                      ...
                      <Typography variant="body1">
                        {stakingAPY === undefined ? <Skeleton width="80px" /> : <>{nextRewardValue} 3DOGs</>}
                      </Typography>
                    </div>
                    ...
                    <div className="data-row">
                      ...
                      <Typography variant="body1">
                        {stakingAPY === undefined ? <Skeleton width="80px" /> : <>{stakingRebasePercentage}%</>}
                      </Typography>
                    </div>
                    ...
                    <div className="data-row">
                      ...
                      <Typography variant="body1">
                        {stakingAPY === undefined ? <Skeleton width="80px" /> : <>{trim(fiveDayRate * 100, 4)}%</>}
                      </Typography>
                    </div>
                  </div>
                </>
